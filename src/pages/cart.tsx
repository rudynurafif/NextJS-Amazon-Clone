...
const CartPage = () => {
  ...
  return (
    <div className='max-w-screen-2xl mx-auto px-6 grid lgl:grid-cols-5 gap-10 py-4'>
      ...
      {cartData.length > 0 ? (
        <>
          <div className='bg-white lgl:col-span-4 p-4 rounded-lg'>
          ...
          <div className='bg-white h-64 max-lgl:w-2/3 lgl:col-span-1 p-4 rounded-lg flex items-center justify-center'>
            <CartPayment />
          </div>
        </>
      ) : (
        <div className='bg-white h-96 col-span-5 flex flex-col gap-2 items-center justify-center py-5 rounded-lg shadow-lg'>
